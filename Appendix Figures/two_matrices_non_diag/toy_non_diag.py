# Simulation for Figure 13 of the appendix.
...
def two_matrices_non_diag(folder, seed=SEED):
    ...
    for angle in angle_list:
        ...
        for d in d_list:
            ...
            sqrt_dSig_list = [
                jnp.diag(jnp.concatenate([jnp.ones(round(d/2)), 2 * jnp.ones(d - round(d/2))])),
                jnp.concatenate(
                    [
...
if __name__ == "__main__":
    ...
    two_matrices_non_diag(HERE / "log", seed=args.seed)
