# Simulation for Figure 6 of the appendix.
...
def two_matrices_one(folder, seed=SEED):
    ...
    for signal_ratio in signal_ratio_list:
        ...
        for d in d_list:
            ...
            sqrt_dSig_list = [
                ...
                jnp.diag(jnp.concatenate([jnp.ones(signal_size), jnp.zeros(d - signal_size)])),
            ]
...
if __name__ == "__main__":
    ...
    two_matrices_one(HERE / "log", seed=args.seed)
